...
def make_pipeline():
    ...
    equity_per_share_growth = FundaMorningstar.equity_per_share_growth.latest    
    gain_loss_on_sale_of_business = FundaMorningstar.gain_loss_on_sale_of_business.latest
    ...
    equity_per_share_growth_winsorize =  equity_per_share_growth.winsorize(min_percentile=0.1, max_percentile=0.95)
    yesterday_winsorize = yesterday.winsorize(min_percentile=0.05, max_percentile=0.95)
    gain_loss_on_sale_of_business_winsorize = gain_loss_on_sale_of_business.winsorize(min_percentile=0.1, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        equity_per_share_growth_winsorize.zscore() + 
        yesterday_winsorize.zscore() +
        gain_loss_on_sale_of_business_winsorize.zscore()
    )
